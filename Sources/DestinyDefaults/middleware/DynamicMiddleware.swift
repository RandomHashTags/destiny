...
public struct DynamicMiddleware : DynamicMiddlewareProtocol {
    public static let defaultOnError:@Sendable (_ request: inout RequestProtocol, _ response: inout DynamicResponseProtocol, _ error: Error) -> Void = { request, response, error in
    ...
    public let handleLogic:(@Sendable (_ request: inout RequestProtocol, _ response: inout DynamicResponseProtocol) throws -> Void)?
    public let handleLogicAsync:(@Sendable (_ request: inout RequestProtocol, _ response: inout DynamicResponseProtocol) async throws -> Void)?
    public let onError:@Sendable (_ request: inout RequestProtocol, _ response: inout DynamicResponseProtocol, _ error: Error) -> Void
    public let onErrorAsync:@Sendable (_ request: inout RequestProtocol, _ response: inout DynamicResponseProtocol, _ error: Error) async -> Void
    ...
    public init(
        ...
        handleLogic: (@Sendable (_ request: inout RequestProtocol, _ response: inout DynamicResponseProtocol) throws -> Void)?,
        handleLogicAsync: (@Sendable (_ request: inout RequestProtocol, _ response: inout DynamicResponseProtocol) async throws -> Void)?,
        onError: @escaping @Sendable (_ request: inout RequestProtocol, _ response: inout DynamicResponseProtocol, _ error: Error) -> Void = DynamicMiddleware.defaultOnError,
        onErrorAsync: @escaping @Sendable (_ request: inout RequestProtocol, _ response: inout DynamicResponseProtocol, _ error: Error) async -> Void = DynamicMiddleware.defaultOnError
    ) {
        self.async = async
    ...
    public func shouldHandle(request: inout RequestProtocol, response: borrowing DynamicResponseProtocol) -> Bool { shouldHandleLogic(&request, response) }
    ...
    public func onErrorAsync(request: inout RequestProtocol, response: inout DynamicResponseProtocol, error: any Error) async {
