...
extension RouterStorage {
    ...
    private func redirectRouteStartLineLiteral(_ route: StaticRedirectionRoute) -> String {
        route.fromStartLine()
    }
    private func redirectRouteStartLineLowercased(_ route: StaticRedirectionRoute) -> String {
